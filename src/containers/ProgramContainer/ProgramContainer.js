  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollableTabView
        ...
        renderTabBar={props => (
          <ProgramTabHeader {...props} allSessions={allSessions} />
        )}>
        {allSessions &&
              ...
              <View tabLabel={item} style={{flex: 1}}>
                <View style={styles.buttonContainer}>
                  <GradientButton
                    ...
                    buttonContainerText={i18n.t(
                      'programScreen.startWorkoutButton',
                    )}
                    ...
                    onPress={() => {
                      if (itemWorkoutUndone) {
                        ...
                        navigation.navigate(Routes.CircularExerciseScreen);
                      }
                    }}
                  />
                </View>
                <View tabLabel={index} style={{flex: 1}}>
                  <CustomProgramTabs
                    navigation={navigation}
